...
/** Liens externes partagés par les deux langues (formulaires Microsoft Forms de YAAC). */
export const externalLinks = {
  membership: 'https://forms.office.com/r/cEwz5H4Bvh',
  partnership: 'https://forms.office.com/r/cEwz5H4Bvh',
  volunteer: 'https://forms.office.com/r/cEwz5H4Bvh',
} as const;
